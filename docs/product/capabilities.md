...
<div class="brand-page-shell">
  ...
  <section class="brand-grid brand-grid--two">
    ...
    <article class="brand-card">
      ...
      <ul class="brand-list">
        ...
        <li>对话执行支持按平台默认或租户范围维护大模型接入配置</li>
  ...
  <section class="brand-card">
    ...
    <ul class="brand-list">
      ...
      <li>Skill 编辑改的是展示、触发、风险、审批、AI/手动执行和可见范围，不是直接改脚本源码</li>
      <li>平台超管与租户管理员可以维护这些 Skill 规则；普通用户只看到自己被授权使用的能力</li>
      <li>个人免费版租户管理员现在也可以把现成脚本直接下发给指定用户，或从脚本侧反向匹配用户</li>
      <li>普通用户仍需先在公告中心确认，脚本和关联 Skill 才会真正进入自己的可见范围</li>
